...
public class CustomerMainInfoVo implements Serializable {
	 private Long id;
	...
	private String memberLevelDescr;
	...
	public String getMemberLevelDescr() {
		return memberLevelDescr;
	}

	public void setMemberLevelDescr(String memberLevelDescr) {
		this.memberLevelDescr = memberLevelDescr;
	}
