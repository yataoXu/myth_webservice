...
<head>
  ...
  <title>借款首页初始化接口</title>
</head>
<body >
<form action="${path}/ApiTest/transmitRequest" method="post">
  <input type="hidden" name="method" value="540003">
  <table align="center">
    <tr>
      <td align="center"><font color="red" size="5">还款详情</font></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right">标的编号<font color="red">*</font>：</td>
