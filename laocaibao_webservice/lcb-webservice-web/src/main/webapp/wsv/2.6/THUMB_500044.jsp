...
<title>转让接口v4.6</title>
</head>
<body >
<form action="${path}/ApiTest/transmitRequest" method="post">
	<input type="hidden" name="method" value="500044">
		<table align="center">
			<tr>
			...
			<tr>
				<td align="center">用户ID：<input type="text"  name="customerId" id="customerId" />
				</td>
			</tr>
			<tr>
				<td align="center">转让利率：<input type="text"  name="transferRate" id="transferRate" />
				</td>
			</tr>
			<tr>
