...
<title>捞财宝转让产品列表接口</title>
</head>
<body>
<form action="${path}/ApiTest/transmitRequest" method="post">
	<input type="hidden" name="method" value="500036">
	<input type="hidden" name="upLowFlag"  id="upLowFlag" value='' />
		<table align="center">
			<tr>
				<td align="center"><font color="red" size="5">转让产品列表接口</font></td>
			</tr>
			<tr>
