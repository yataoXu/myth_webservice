...
<head>
  ...
  <title>捞财宝验证码发送接口</title>
</head>
<body >
<form action="${path}/wsv/thumb900011" method="post">
  <input type="hidden" name="method" value="900011">
  <table align="center">
    <tr>
      <td colspan="2"  align="center"><font color="red" size="5">验证码接口</font></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right">短信类型<font color="red">*</font>：</td>
      <td>
        <select style="width: 200px" name="codeType" id="codeType">
