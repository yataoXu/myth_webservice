...
<body>
	<div>
		<table border="1" align="center" style="width: 300px;text-align: center;">
			<tr><td><a href="${sessionScope.path}/wsv/3.0/THUMB_500060.jsp" target="_blank">投资记录</a></td></tr>
            <tr><td><a href="${sessionScope.path}/wsv/3.0/THUMB_820018.jsp" target="_blank">2016年度账单</a></td></tr>
		</table>
	</div>
</body>
</html>
