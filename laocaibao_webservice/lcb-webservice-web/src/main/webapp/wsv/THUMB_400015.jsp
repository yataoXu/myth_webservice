...
<title>捞财宝--用户邀请好友消费记录接口</title>
</head>
<body >
<form action="${path}/wsv/thumb400015" method="post">
	<input type="hidden" name="method" value="400015">
		<table align="center">
			<tr>
				<td align="center"><font color="red" size="5">用户邀请好友消费记录接口</font></td>
			</tr>
			<tr>
