...
<form action="${path}/ApiTest/transmitRequest" method="post">
	<input type="hidden" name="method" value="521005">
		<table align="center">
			<tr>
				<td align="center"><font color="red" size="5">续投接口</font></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right">续投类型：</td>
				<td> <input name="reinvestType" id="reinvestType" type="text" value=''></td>
			</tr>
			<tr>
