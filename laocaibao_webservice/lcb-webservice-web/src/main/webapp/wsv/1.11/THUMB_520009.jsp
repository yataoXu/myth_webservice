...
<title>捞财宝2.0--提现接口</title>
</head>
<body>
<form action="${path}/ApiTest/transmitRequest" method="post">
	<input type="hidden" name="method" value="520009">
		<table align="center">
			<tr>
				<td align="center"><font color="red" size="5">提现接口</font></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td> <input name="withDrawAmount" id="withDrawAmount" type="text" value=''></td>
			</tr>
			<tr>
