...
<title>捞财宝重置密码接口</title>
</head>
<body >
<form action="${path}/wsv/thumb400005" method="post">
	<input type="hidden" name="method" value="400005">
		<table align="center">
			<tr>
				<td colspan="2"  align="center"><font color="red" size="5">重置密码接口</font></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td> <input name="cmPassword" id='cmOldPassword' type="text" size="100"
					maxlength="50" >
				</td>
			</tr>
