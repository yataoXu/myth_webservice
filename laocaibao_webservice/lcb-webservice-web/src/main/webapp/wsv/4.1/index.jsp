...
<body>
	<div>
		<table border="1" align="center" style="width: 300px;text-align: center;">
			<tr><td><a href="${sessionScope.path}/wsv/4.1/THUMB_500029.jsp" target="_blank">回款日历</a></td></tr>
			<tr><td><a href="${sessionScope.path}/wsv/4.1/THUMB_500030.jsp" target="_blank">资产详情</a></td></tr>
		</table>
	</div>
</body>
</html>
