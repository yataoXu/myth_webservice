...
<title>拇指贷前置系统-返利明细接口</title>
</head>
<body>
  <form action="${path}/ApiTest/transmitRequest" method="post" name="model_500006">
	<input type="hidden" name="method" value="500006">
	<table align="center">
			<tr>
				<td align="center"><font color="red" size="5">返利明细接口</font></td>
			</tr>
			<tr>
