...
<body>
  <form action="${path}/ApiTest/transmitRequest" method="post" name="model_600002">
	<input type="hidden" name="method" value="600002">
	<table align="center">
			<tr>
				<td align="center"><font color="red">消息中心接口</font></td>
			</tr>
			<tr>
