...
<form action="${path}/ApiTest/transmitRequest" method="post">
	<input type="hidden" name="method" value="400018">
		<table align="center">
			<tr>
			...
			<tr>
				...
				<td> <input name="cellphone" id='cellphone' type="text" size="100"
					maxlength="11" value='15800459433'>
				</td>
			</tr>
			<tr>
				<td align="right">密码<font color="red">*</font>：</td>
				<td> <input name="password" id='password' type="text" size="100"
			...
			<tr>
				...
				<td> <input name="cmIntroduceCode" id='introduceCode' type="text" size="100"
					maxlength="11" value=''>
				</td>
			</tr>
			<tr>
				<td align="right">商户码邀请码：</td>
				<td> <input name="merchantNo" id='merchantNo' type="text" size="100"
							maxlength="11" value=''>
				</td>
			</tr>
			<tr>
				<td align="right">微信号：</td>
				<td> <input name="openId" id='openId' type="text" size="100"
					 value=''>
				</td>
			</tr>
			<tr>
