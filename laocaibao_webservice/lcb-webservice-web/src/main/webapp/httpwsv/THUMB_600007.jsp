...
<body>
<form action="${path}/ApiTest/transmitRequest" method="post" name="model_600007">
	<input type="hidden" name="method" value="600007">
	<table align="center">
	
			<tr>
				<td align="center"><font color="red" size="5">账户流水查询</font></td>
			</tr>
			<tr>
