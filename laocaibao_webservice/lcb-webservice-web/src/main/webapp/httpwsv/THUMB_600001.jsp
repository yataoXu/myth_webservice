...
<body>
  <form action="${path}/ApiTest/transmitRequest" method="post" name="model_600001">
	<input type="hidden" name="method" value="600001">
		<table>
			...
			<tr>
				<td align="right">问题分类：1,账号 2,绑卡/充值/提现 ,3 活动 4 收银台 5,产品 ,6 功能故障 7 福利 8 其他建议</td>
				<td colspan="5">
					<input name="feedbackType" type="text">
				</td>
			</tr>
			<tr>
