...
<body>
  	<form action="${path}/ApiTest/transmitRequest" method="post" name="model_700002">
	<input type="hidden" name="method" value="700002">
		<table align="center">
			<tr>
				<td colspan="2"  align="center"><font color="red" size="5">积分账户余额</font></td>
			</tr>
			<tr>
