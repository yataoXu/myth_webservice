...
public final class SpringUtils implements BeanFactoryPostProcessor {
    ...
    public static void destroySingleton(Class clz){
        if(beanFactory instanceof DefaultSingletonBeanRegistry){
            DefaultSingletonBeanRegistry dsbr = (DefaultSingletonBeanRegistry) SpringUtils.beanFactory;
            String[] beanNamesForType = beanFactory.getBeanNamesForType(clz);
            for (String beanName : beanNamesForType) {
                dsbr.destroySingleton(beanName);
            }
        }
    }
