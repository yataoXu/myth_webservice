...
public class BusiTransferProductVO extends BusiProduct{
    ...
    private Integer personLoan;//个贷标识
    ...
    @Override
    public void setPersonLoan(Integer personLoan) {
        this.personLoan = personLoan;
    }

    @Override
    public Integer getPersonLoan() {
        return personLoan;
    }
}
